# Public: The AssemblStore plugin can be used to persist annotations to a database
...
class Annotator.Plugin.AssemblStore extends Annotator.Plugin
  ...
  # Public: The contsructor initailases the AssemblStore instance. It requires the
  ...
  # Examples
  #
  #   store = new Annotator.Plugin.AssemblStore(Annotator.element, {
  ...
  #   })
  #
  # Returns a new instance of AssemblStore.
  ...
  # the AssemblStore#loadAnnotationsFromSearch method rather than AssemblStore#loadAnnotations.
  #
  # Returns nothing.
  _getAnnotations: =>
  ...
  # Public: Registers an annotation with the AssemblStore. Used to check whether an
  # annotation has already been created when using AssemblStore#annotationCreated().
  #
  ...
  # Public: Unregisters an annotation with the AssemblStore.
  #
  # NB: registerAnnotation and unregisterAnnotation do no error-checking/
  # duplication avoidance of their own. Use with care.
  #
  ...
  # Callback method for AssemblStore#loadAnnotations(). Processes the data
  ...
  # Public: Performs the same task as AssemblStore.#loadAnnotations() but calls the
  ...
  # Callback method for AssemblStore#loadAnnotationsFromSearch(). Processes the data
  # returned from the server (a JSON array of annotation Objects) and updates
  # the registry as well as loading them into the Annotator.
  #
  # data - An Array of annotation Objects
